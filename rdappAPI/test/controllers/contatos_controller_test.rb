...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { email: @contato.email, user_id: @contato.user_id } }, as: :json
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { email: @contato.email, user_id: @contato.user_id } }, as: :json
    assert_response 200
  end
